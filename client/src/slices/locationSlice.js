	...
	locations: [
		{
			...
			address: null,
			comment:
				"This refill location has been sourced from public data\n",
			category_id: 3,
			coordinate: null,
			photo_url: null,
		...
		},
		{
			...
			latitude: 35.6568587,
			address:
				"桂園, Shibakoen 2 Chome, Tokyo, Chiyoda, Tokyo Prefecture, Japan",
			comment: null,
			category_id: 0,
			coordinate: null,
			photo_url:
				"https://my-mizu-dev2-gen8n.ondigitalocean.app/api/photos/24",
			copyright: null,
			photos: [
				{
					id: 24,
		...
		},
		{
			...
			latitude: 35.6549594,
			address:
				"Akabanebashi Eki, Mita 1 Chome, Tokyo, Chiyoda, Tokyo Prefecture, Japan",
			comment: null,
			category_id: 0,
			coordinate: null,
			photo_url:
				"https://my-mizu-dev2-gen8n.ondigitalocean.app/api/photos/32",
			copyright: null,
			photos: [
				{
					id: 32,
		...
		},
		{
			...
			latitude: 35.6563703,
			address:
				"ＳＳＳ４５, Azabujuban 2 Chome, Tokyo, Chiyoda, Tokyo Prefecture, Japan",
			comment: null,
			category_id: 0,
			coordinate: null,
			photo_url:
				"https://my-mizu-dev2-gen8n.ondigitalocean.app/api/photos/33",
			copyright: null,
			photos: [
				{
					id: 33,
		...
		},
		{
			...
			comment:
				"How to Refill:Located on first floor１階にあります。\n\n",
			category_id: 0,
			coordinate: null,
			photo_url: null,
			copyright: null,
		...
		},
		{
			...
			latitude: 35.6456548,
			address:
				"Aiiku Hospital, Kaigan 2 Chome, Tokyo, Chiyoda, Tokyo Prefecture, Japan",
			comment: null,
			category_id: 0,
			coordinate: null,
			photo_url:
				"https://my-mizu-dev2-gen8n.ondigitalocean.app/api/photos/595",
			copyright: null,
			photos: [
				{
					id: 595,
		...
		},
		{
			...
			latitude: 35.6598607,
			address:
				"御成門駅, Shibakoen 1 Chome, Tokyo, Chiyoda, Tokyo Prefecture, Japan",
			comment:
				"Refill spot located on the Mita line platform near compartment 4\n\n",
			category_id: 2,
			coordinate: null,
			photo_url:
				"https://my-mizu-dev2-gen8n.ondigitalocean.app/api/photos/809",
			copyright: null,
			photos: [
				{
					id: 809,
		...
		},
		{
			...
			latitude: 35.6551782,
			address:
				"Lost & Found Office, Shibakoen 2 Chome, Tokyo, Chiyoda, Tokyo Prefecture, Japan",
			comment: "water refill spot inside the park\n\n",
			category_id: 0,
			coordinate: null,
			photo_url:
				"https://my-mizu-dev2-gen8n.ondigitalocean.app/api/photos/914",
			copyright: null,
			photos: [
				{
					id: 914,
		...
		},
		{
			...
			comment:
				"In the middle of the platform, by where car 6 stops on both northbound and southbound trains.\n\n",
			category_id: 2,
			coordinate: null,
			photo_url:
				"https://my-mizu-dev2-gen8n.ondigitalocean.app/api/photos/1420",
			copyright: null,
			photos: [
				{
					id: 1420,
		...
		},
		{
			...
			latitude: 35.6579681,
			address:
				"〒106-0044 東京都港区東麻布1丁目4-2THE WORKERS & CO",
			comment:
				"Hours: Mon - Sat 12:00 - 14:00 and 18:00 - 22:00How to Refill:Please ask a member of staff.Type of Water: Tap water / Chilled tap water Location:5 minute walk from Akabanebashi station and Kamiyacho station\n\n",
			category_id: 4,
			coordinate: null,
			photo_url:
				"https://my-mizu-dev2-gen8n.ondigitalocean.app/api/photos/1699",
			copyright: null,
			photos: [
				{
					id: 1699,
		...
		},
		{
			...
			latitude: 35.6533867,
			address:
				"2 Chome-13 Shibadaimon, Minato City, Tokyo 105-0012, Japan",
			comment: "Refill spot located inside of park\n\n",
			category_id: 0,
			coordinate: null,
			photo_url:
				"https://my-mizu-dev2-gen8n.ondigitalocean.app/api/photos/2199",
			copyright: null,
			photos: [
				{
					id: 2199,
		...
		},
		{
			...
			latitude: 35.6515807,
			address:
				"2-chōme-12-3 Shiba, Minato City, Tōkyō-to 105-0014, Japan",
			comment: "Refill Spot in the park\n\n",
			category_id: 0,
			coordinate: null,
			photo_url:
				"https://my-mizu-dev2-gen8n.ondigitalocean.app/api/photos/2410",
			copyright: null,
			photos: [
				{
					id: 2410,
		...
		},
		{
			...
			latitude: 35.6568311,
			address:
				"日本、〒105-0011 東京都港区芝公園４丁目５ Unnamed Road、４丁目-５ 芝公園 18号地児童遊園時計塔",
			comment:
				"Refill spot located inside the park (right in the center).\n\n",
			category_id: 0,
			coordinate: null,
			photo_url:
				"https://my-mizu-dev2-gen8n.ondigitalocean.app/api/photos/2491",
			copyright: null,
			photos: [
				{
					id: 2491,
		...
		},
		{
			...
			latitude: 35.6432128,
			address:
				"日本、〒108-0073 東京都港区三田４丁目１６−２０ 亀塚公園",
			comment:
				"Refill spot located inside the park, near the pergola at the back.\n\n",
			category_id: 0,
			coordinate: null,
			photo_url:
				"https://my-mizu-dev2-gen8n.ondigitalocean.app/api/photos/2515",
			copyright: null,
			photos: [
				{
					id: 2515,
		...
		},
		{
			...
			latitude: 35.6425083,
			address:
				"日本、〒108-0073 東京都港区三田４丁目１７−２８",
			comment:
				"Refill spot located inside the park, near the toilet.\n\n",
			category_id: 0,
			coordinate: null,
			photo_url:
				"https://my-mizu-dev2-gen8n.ondigitalocean.app/api/photos/2516",
			copyright: null,
			photos: [
				{
					id: 2516,
		...
		},
		{
			...
			latitude: 35.6555798,
			address:
				"日本、〒106-0044 東京都港区東麻布１丁目２１−８",
			comment:
				"Refill spot located inside the park. Next to the swing\n\n",
			category_id: 0,
			coordinate: null,
			photo_url:
				"https://my-mizu-dev2-gen8n.ondigitalocean.app/api/photos/2523",
			copyright: null,
			photos: [
				{
					id: 2523,
		...
		},
		{
			...
			latitude: 35.6509831,
			address:
				"日本、〒106-0047 東京都港区南麻布１丁目７−２８",
			comment: "Near the main entrance\n\n",
			category_id: 0,
			coordinate: null,
			photo_url:
				"https://my-mizu-dev2-gen8n.ondigitalocean.app/api/photos/2707",
			copyright: null,
			photos: [
				{
					id: 2707,
		...
		},
		{
			...
			comment:
				"Close to the main gate of Zojoji temple\n\n",
			category_id: 0,
			coordinate: null,
			photo_url:
				"https://my-mizu-dev2-gen8n.ondigitalocean.app/api/photos/2748",
			copyright: null,
			photos: [
				{
					id: 2748,
		...
		},
		{
			...
			latitude: 35.6578454,
			address:
				"Hiashiazabu Children's Playground, 1-chōme-2-1 Higashiazabu, Minato City, Tōkyō-to 106-0044, Japon",
			comment: "Refill spot located inside the park.\n\n",
			category_id: 0,
			coordinate: null,
			photo_url:
				"https://my-mizu-dev2-gen8n.ondigitalocean.app/api/photos/2764",
			copyright: null,
			photos: [
				{
					id: 2764,
		...
		},
		{
			...
			comment:
				"Water fountain next to Momiji-dani near the clock tower.\n\n",
			category_id: 0,
			coordinate: null,
			photo_url:
				"https://my-mizu-dev2-gen8n.ondigitalocean.app/api/photos/3214",
			copyright: null,
			photos: [
				{
					id: 3214,
		...
		},
		{
			...
			coordinate: null,
			photo_url:
				"https://my-mizu-dev2-gen8n.ondigitalocean.app/api/photos/3215",
			copyright: null,
			photos: [
				{
					id: 3215,
		...
		},
		{
			...
			coordinate: null,
			photo_url:
				"https://my-mizu-dev2-gen8n.ondigitalocean.app/api/photos/3216",
			copyright: null,
			photos: [
				{
					id: 3216,
		...
		},
		{
			...
			latitude: 35.6597161,
			address:
				"3 Chome-4 Shibakoen, Minato City, Tokyo 105-0011, Japan",
			comment:
				"Refill spot next to the toilet in Ichozaka\n\n",
			category_id: 0,
			coordinate: null,
			photo_url:
				"https://my-mizu-dev2-gen8n.ondigitalocean.app/api/photos/3434",
			copyright: null,
			photos: [
				{
					id: 3434,
		...
		},
		{
			...
			latitude: 35.6539291,
			address:
				"Shibakoen Sta., 4-chōme-8-14 Shibakōen, Minato City, Tōkyō-to 105-0011, Japan",
			comment:
				"Refill spot located on platform 2 of the station\n\n",
			category_id: 2,
			coordinate: null,
			photo_url:
				"https://my-mizu-dev2-gen8n.ondigitalocean.app/api/photos/3744",
			copyright: null,
			photos: [
				{
					id: 3744,
		...
		},
		{
			...
			latitude: 35.6622084,
			address:
				"港区愛宕2-5-1愛宕グリーンヒルズMORIタワー1F",
			comment: "Hours: 11:00am-8:00pm\n\n",
			category_id: 4,
			coordinate: null,
			photo_url:
				"https://my-mizu-dev2-gen8n.ondigitalocean.app/api/photos/106",
			copyright: null,
			photos: [
				{
					id: 106,
		...
		},
		{
			...
			comment:
				"Hours:Weekdays 9:00-17:00How to Refill:Please ask a member of staff.Type of Water:Filtered water\n\n",
			category_id: 4,
			coordinate: null,
			photo_url:
				"https://my-mizu-dev2-gen8n.ondigitalocean.app/api/photos/676",
			copyright: null,
			photos: [
				{
					id: 676,
...
export const nearLocationsAction = createAsyncThunk(
	...
	async ({ lat, long }) => {
		...
		const endpoint = `https://my-mizu-dev2-gen8n.ondigitalocean.app/dev-api/search/area?c1=${
			lat + distance
		}&c2=${long - distance}&c3=${lat - distance}&c4=${
			long + distance
		}`;
		const request = await axios.get(endpoint, {
			headers: {
				Authorization:
					"Bearer 60|YuyKMkzJbvGUqtJwq9UqWlwtbEBmoOlxfBMQ0jlT",
			},
		});
